package ru.tonkoshkurov.myfirstthymeleaf.controller;


import ru.tonkoshkurov.myfirstthymeleaf.dao.StudentRepository;
...
public class StudentController {
    ...
    public ModelAndView showUpdateForm(@RequestAttribute int studentId) {
        ModelAndView mav = new ModelAndView("add-student-form");
